...
- [ ] Create Python project structure (`backend/`)
- [ ] Implement `engine/calculator.py` with all formulas:
  - [ ] Time calculations (years_to_retirement, retirement_years)
  - [ ] Inflated expense calculation
  - [ ] Corpus required (growing annuity model)
  - [ ] Future value of existing assets
  - [ ] Deficit calculation
  - [ ] Fixed monthly SIP
  - [ ] Step-up SIP (growing annuity)
